package com.bockerl.snailmember.boardrecomment.query.vo
...
data class QueryBoardRecommentResponseVO(
    @field:Schema(description = "게시글 대댓글 고유 번호(PK)", example = "BOA-REC-00000001", type = "String")
    @JsonProperty(namespace = "boardRecommentId")
    val boardRecommentId: String? = null,
    @field:Schema(description = "게시글 댓글 고유 번호", example = "BOA-COM-00000001", type = "String")
    @JsonProperty(namespace = "boardCommentId")
    val boardCommentId: String? = null,
    @field:Schema(description = "게시글 대댓글 내용", example = "달팽이 좋아요", type = "String")
    @JsonProperty(namespace = "boardRecommentContents")
    ...
    @field:Schema(description = "게시글 고유 번호", example = "BOA-00000001", type = "Long")
    ...
    @field:Schema(
        description = "게시글 대댓글 gif",
        example = "https://-4bf8-a32b-7e4bca1e1466.png",
        type = "String",
    )
    @JsonProperty(namespace = "boardRecommentGif")
    val boardRecommentGif: String? = "",
) : Serializable