...
interface CommandFileService{
    ...
    fun uploadFilesWithGatheringId(files: List<MultipartFile>, commandFileWithGatheringRequestVO: CommandFileWithGatheringRequestVO)
    ...
    fun updateFilesWithGatheringId(commandFileWithGatheringRequestVO: CommandFileWithGatheringRequestVO, deletedFileIds: List<Long>, newFiles: List<MultipartFile>)
