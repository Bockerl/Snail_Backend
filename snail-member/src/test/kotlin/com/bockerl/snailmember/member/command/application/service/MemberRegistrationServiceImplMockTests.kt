...
class MemberRegistrationServiceImplMockTests : TestSupport() {
    @Mock
...
//            doNothing().`when`(memberAuthService).createEmailVerificationCode(TEST_EMAIL)
//
//            // when
...
//                )
//            whenever(tempMemberRepository.find(TEST_REDIS_ID)).thenReturn(tempMember)
//            doNothing().`when`(memberAuthService).verifyCode(any(), any(), any())
...
//            // 인증 서비스 검증
//            verify(memberAuthService).verifyCode(
//                eq(TEST_EMAIL),
...
//                )
//            whenever(tempMemberRepository.find(TEST_REDIS_ID)).thenReturn(tempMember)
//            whenever(memberAuthService.createPhoneVerificationCode(TEST_PHONE)).thenReturn(VERIFICATION_CODE)
//            doNothing().`when`(tempMemberRepository).update(any(), any())
//
//            // when
...
//            verify(memberAuthService).createPhoneVerificationCode(
//                eq(TEST_PHONE),
//            )
//            verify(tempMemberRepository).update(
//                eq(TEST_REDIS_ID),
...
//                registrationService.createPhoneRefreshCode(TEST_REDIS_ID)
//            }
//            verify(memberAuthService).createPhoneVerificationCode(TEST_PHONE)
//        }
//
//        @Test
...
//            // then
//            assertEquals(result, TEST_REDIS_ID)
//            verify(memberAuthService).verifyCode(TEST_PHONE, VERIFICATION_CODE, VerificationType.PHONE)
//            verify(tempMemberRepository).update(
//                eq(TEST_REDIS_ID),
//                argThat { updatedMember ->
//                    updatedMember.email == TEST_EMAIL &&
